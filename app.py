...
with st.form("form_arraia", clear_on_submit=True):
    ...
    if category == "Quero trazer um Salgado" if 'category' in locals() else categoria == "Quero trazer um Salgado":
    ...
    elif category == "Quero trazer um Doce" if 'category' in locals() else categoria == "Quero trazer um Doce":
