...
# Juntamos tudo em uma lista única para evitar recarregamentos de página
lista_completa_pratos = salgados_filtrados + ["Outros Salgados"] + doces_filtrados + ["Outros Doces"]

# 5. Criamos o formulário COMPLETO (Tudo aqui dentro fica protegido e não some)
with st.form("form_arraia", clear_on_submit=True):
    ...
    # Seleção do prato unificada dentro do formulário
    escolha_prato = st.selectbox("Escolha o que você vai trazer (Salgados ou Doces):", lista_completa_pratos)
    
    # Campo de texto livre que sempre fica visível para caso a pessoa precise especificar
...
if enviado:
    if nome and whatsapp:
        ...
        # Define a categoria e validação do "Outros"
        if "Outros" in escolha_prato:
            ...
            # Remove o prefixo "Salgado: " ou "Doce: " para salvar limpo na planilha
        ...
        if comida_final:
            ...
            # Guarda na sessão para a mensagem de sucesso
